...
function draw(s) {
  ...
  if (existing.length !== seats.length) {
    ...
    seats.forEach(function (seat) {
      ...
      wrap.appendChild(el("i", "hands"));
      var spr = el("div", "sprite " + String(seat.name || "Scout").toLowerCase());
    ...
    seats.forEach(function (seat, i) {
      ...
      var spr = card.querySelector(".sprite");
      if (spr) spr.className = "sprite " + String(seat.name || "Scout").toLowerCase();
    });
  }
